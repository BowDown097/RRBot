...
public static class Constants
{
    ...
    [
        new Weapon("Glock 17", 30, "Pistol Round", 13, 21, 40, "The classic. Also the weakest. Upgrade when?", ["Bronze", "Silver", "Gold", "Diamond"], "Gun"),
        new Weapon("Python", 35, "Pistol Round", 20, 25, 30, "Nice, small, and hits like a truck. Like a Glock but it doesn't suck.", ["Silver", "Gold", "Diamond"], "Gun"),
        new Weapon("AR-15", 50, "Rifle Round", 40, 45, 25, "\"Ummmm.. This is like a full on military weapon, we should ban it\" said some fucking loser no one cares about. This gun is awesome.", ["Gold", "Diamond"], "Gun"),
        new Weapon("M16", 60, "Rifle Round", 35, 40, 20, "TA-TA-TA! Three round burst. Nice n' accurate. Absolute beauty.", ["Gold", "Diamond"], "Gun"),
        new Weapon("Intervention", 70, "Sniper Round", 60, 80, 3, "Big dick energy in a weapon. Sexy. Accurate. Hard-hitting. The bros love it, the hoes love it. I love it.", ["Gold", "Diamond"], "Gun"),
        new Weapon("Barrett M82", 60, "Sniper Round", 50, 70, 7, "Yawn. Gay. It's cool I guess, but why have this when you could have an Intervention?", ["Gold", "Diamond"], "Gun"),
        new Weapon("RPG", 30, "Rocket", 99, 100, 15, "A FUCKIN' ROCKET LAUNCHER!!!! GUN GO BOOM!", ["Diamond"], "Gun")
    ];
    // ********************
    //      SCAVENGE
    // ********************
    public static readonly Dictionary<string, string> ScavengeWordSet = new()
    {
        { "ant", "hormiga" },
        { "zebra", "cebra" },
        { "snail", "caracol" },
